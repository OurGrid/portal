...
public class LvcJobPanel extends PluginCreateJobPanel {
	...
	@Override
	protected LvcJobSubmissionPanel createJobSubmitPanel(int jobViewId,TabItem container) {
		return new LvcJobSubmissionPanel(jobTabCounter,jobViewId, container);
	}
	...
	public TabItem addTab(AbstractRequest request) {
		...
		LvcJobRequest lvcRequest = (LvcJobRequest) request;
