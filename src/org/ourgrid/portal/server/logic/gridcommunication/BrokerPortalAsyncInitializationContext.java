...
public class BrokerPortalAsyncInitializationContext implements 
		InitializationContext<BrokerManager, BrokerPortalAsyncManagerClient> {

	public BrokerPortalAsyncManagerClient createManagerClient() {
		return new BrokerPortalAsyncManagerClient();
	}
